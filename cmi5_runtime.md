...
```javascript
   "context": {
     ...
     "extensions" {
       "http://purl.org/xapi/cmi5/context/extensions/sessionid": "<sessionId provided by the LMS>",
...
<table>
  ...
  <tr><th align ="right" nowrap>LMS Usage:</th><td>The value for sessionId is generated by the LMS. The LMS MUST also record the sessionId in the State API (See Section 10) prior to launching an AU. The LMS MUST also provide the sessionId in the context as an extension for all Statements (with cmi5 defined verbs) it makes directly in the LRS.</td></tr>
