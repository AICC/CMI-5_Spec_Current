...
&nbsp;&nbsp;&nbsp;&nbsp;[6.3 LMS Agent Profile API Requirements](#lms_agent_profile_api_requirements)  
&nbsp;&nbsp;&nbsp;&nbsp;[6.4 LMS Statement API Requirements](#lms_statement_api_requirements)  
[__7.0 AU Requirements__](#au_requirements)  
&nbsp;&nbsp;&nbsp;&nbsp;[7.1 AU State API Requirements](#au_state_api_requirements)  
&nbsp;&nbsp;&nbsp;&nbsp;[7.2 AU Agent Profile API Requirements](#au_agent_profile_api_requirements)  
&nbsp;&nbsp;&nbsp;&nbsp;[7.3 AU Statement API Requirements](#au_statement_api_requirements)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[7.3.1 Placement of session_id in Statements](#placement)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[7.3.2 First Statement API Call](#first_statement_au)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[7.3.2 Last Statement Call](#last_statement_au)  
...
<a name="lms_agent_profile_api_requirements"></a>  
##6.3 LMS Agent Profile API Requirements
If used, the agent profile documents as described in this section
should be set before the learner accesses the course. 
The agent profile documents are specific to the learner.  

####_Learner Preferences_ 
__Description__: Learner preference data from the LMS relevant to any AU  

__Usage__: Static.  The LMS shall only create one Agent Profile document for this agent.  

__State Document Format__: Application/JSON  

__State Document Content__: The properties for the Learner.Preferences document are described
below.
...
<tr>
    ...
    AU being launched.<strong></strong><br />
      ...
      <strong>LMS Usage:  </strong>LMS may use this document to pass a learner's language preferences to the AU. The LMS should not use any other mechanism to pass language preferences. <br />
      <strong>AU Usage: </strong>An AU which supports multiple languages shall check this document when
      selecting a language. The AU is free to make it's own decision of what language(s) to present the
      learner based on the information presented by the LMS. If this document is not present, the AU shall
      use another mechanism to select the language. The AU may create and amend this document where
      appropriate and where it has LRS permissions to do so. <br />
      <strong>Data type: </strong>Array<br />
      <strong>Value space: </strong>An array of [RFC 5646](http://tools.ietf.org/html/rfc5646) 
      Language Tags<br />
      <strong>Sample value: </strong>[fr, en-gb, en]</p></td>
  </tr>
</table>

__Agent Profile API PUT Properties__:

* _agent_: agent representing the LMS learner being enrolled.  Shall match actor object
generated by LMS at AU launch time.  
* _profileId_: Learner.Preferences 



<a name="lms_statement_api_requirements"></a>  
##6.4 LMS Statement API Requirements
...
<a name="au_agent_profile_api_requirements"></a> 
##7.2 AU Agent Profile API Requirements



<a name="au_statement_api_requirements"></a>  
##7.3 AU Statement API Requirements

<a name="placement"></a> 
###7.3.1 Placement of session_id in Statements
...
###7.3.2 First Statement API Call
