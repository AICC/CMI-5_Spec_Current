...
<table>
  <tr><th align ="right" nowrap>ID:</th><td>http://adlnet.gov/ns/xapi/cmi5/extensions/result/session</td></tr>
...
####9.6.3.2 reason
  ...
  <table>
  <tr><th align ="right" nowrap>ID:</th><td>http://adlnet.gov/ns/xapi/cmi5/extensions/result/reason</td></tr>
...
```javascript
{
   "contextTemplate": {
         "extensions": {
            "http://adlnet.gov/ns/xapi/cmi5/extensions/session": "<LMS generated sessionId>"
         }
   },
