...
```javascript
   "context": {
     ...
     "contextActivities": {
        "category": {[
          {"id": "http://adlnet.gov/xapi/cmi5/moveon"},
          {"id": "http://adlnet.gov/xapi/cmi5/cmi5"}
        ]}
     },
     "extensions" {
       "http://purl.org/xapi/cmi5/result/extensions/sessionid": "<session id provided by the LMS>",
       "http://purl.org/xapi/cmi5/result/extensions/reason": "<reason for 'waived' verb, if statement is 'waived' statement only>",
      }
   }
```
...
<table>
  <tr><th align ="right" nowrap>ID:</th><td>http://purl.org/xapi/cmi5/result/extensions/sessionid</td></tr>
...
```javascript
{
   "contextTemplate": {
         "extensions": {
            "http://purl.org/xapi/cmi5/result/extensions/sessionid": "<LMS generated sessionId>"
         }
   },
...
<tr>
    <td><p><strong>Description: </strong>Context template for the AU being launched.<br />
      ...
      <strong>LMS Usage:  </strong>LMS MUST include a contextTemplate and place the value for <strong><em>sessionId</em></strong> in the "http://adlnet.gov/ns/xapi/cmi5/extensions/session" element
