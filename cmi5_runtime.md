...
```javascript
  "result": {
     ...
     "duration": "PT30M",
     "extensions": {
         "http://adlnet.gov/ns/xapi/cmi5/extensions/result/progress": "100"
     }
   }
 ```
...
<table>
  <tr><th align ="right" nowrap>ID:</th><td>http://adlnet.gov/ns/xapi/cmi5/extensions/context/session</td></tr>
...
####9.6.3.2 reason
  ...
  <table>
  <tr><th align ="right" nowrap>ID:</th><td>http://adlnet.gov/ns/xapi/cmi5/extensions/context/reason</td></tr>
...
```javascript
{
   "contextTemplate": {
         "extensions": {
            "http://adlnet.gov/ns/xapi/cmi5/extensions/context/session": "<LMS generated sessionId>"
         }
   },
