...
<table>
  <tr><th align=“right” nowrap>Description:</th><td>The <code>launchParameters</code> defined in the cmi5 Course Structure.</td></tr>
  ...
  <tr><th align=“right” nowrap>AU Usage:</th><td>The AU SHOULD get the <code>LMS.LaunchData</code> State document value from the State API document if the launch parameters were defined in the Course Structure.</td></tr>
  <tr><th align=“right” nowrap>Data Type:</th><td>String</td></tr>
  <tr><th align=“right” nowrap>Value Space:</th><td>Any string value</td></tr>
</table>
