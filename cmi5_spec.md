...
<table>
  ...
  <tr><th align="right">Description:</th><td>The <strong><em>fetch</em></strong> URL is used by the AU to obtain an authorization token created &amp; managed by the LMS. The authorization token is used by the AU being launched.</td></tr>
